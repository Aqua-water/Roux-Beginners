...
本教程提供了大量的虚拟魔方演示，可以拖动以改变朝向；对于带有转动的演示，点击它们以执行转动。虚拟魔方的下方还有单步执行、恢复等选项，你可以自行探索。

本教程建议使用电脑端阅读，以更方便地观察这些虚拟魔方。如果使用手机端，尽量不要拖动虚拟魔方。

### 复原步骤的阅读

桥式复原法中，每个阶段都有很多种可能的情形(case)，因此会涉及到分类讨论。你可以先像查字典一样，观察你手中的魔方对应的情形，确定应当按照教程中的哪一种方式复原，而不必一开始就逐句阅读。
