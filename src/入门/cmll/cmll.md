...
CMLL步骤中会引入一些**公式**（在本教程中，指的是4步以上的转动序列）。
...
<img src="./images/cmll-eo_flowchart.png" height = "300"/>

> 注意，使用公式完成形态转换后，通常还需要做`Ux`调整朝向。

### 公式法

直接复原的公式如下：

<img src="./images/cmll-eo.png" height = "450"/>
...
<img src="./images/cmll-pos_flowchart.png" height = "300"/>
